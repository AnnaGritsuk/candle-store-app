...
export class Header extends Component{
    constructor(parrent: HTMLElement) {
        ...
        const nav_katalog = new Component (nav1.root, 'a', ["nav_katalog"], null,["href"],["#katalog"]);
        new Component (nav_katalog.root, 'img', null , null, ["src", "alt"],["./assets/katalog.png", "katalog"]);
        const nav_statistika = new Component (nav1.root, 'a', ["nav_statistika"], null,["href"],["#statistika"]);
        ...
        const nav_korzina = new Component (nav2.root, 'a', ["nav_korzina"], null,["href"],["#korzina1"]);
        new Component (nav_korzina.root, 'img', null , null, ["src", "alt"],["./assets/korzina.png", "korzina"]); 
        const nav_user = new Component (nav2.root, 'a', ["nav_user"], null,["href"],["#user"]);
